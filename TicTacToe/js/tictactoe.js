...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
       ...
       if(activePlayer === 'O') {
           ...
           disableClick(); 
           //this funciton waits 1 second before computer places images and enables click
    ...
    function computersTurn() {
        ...
        let success = false; 
        //this variable stores a ranodm number 0-8
        let pickASquare; 
...
function checkWinConditions() {
    ...
    //squares are selected the tie game sound 
        ...
        audio('./media./zapsplat_bells_small_hand_bell_ring_in_water_weird_cartoon_tone_005_61910.mp3');
        //this functionii sets a .3 second timer before the resetGame is called
