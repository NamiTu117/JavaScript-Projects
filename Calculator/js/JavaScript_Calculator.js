...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if Wait_Second_Operator is true, 
    ...
    if (First_Operand == null) {
        ...
        //if the Perform_Calculator object and the function that matches the
...
const Perform_Calculation = {
   ...
   //this function updates the screen with the contents of display
   ...
   keys.addEventListener('click', (event) => {
       //the target variable is an object the represents the element 
       // that was clicked
       const {target} = event; 
